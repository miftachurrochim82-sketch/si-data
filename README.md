...
## 🎯 Tugas Admin Satu Data (Satpol PP & Kebakaran)
- **Koleksi** data sektoral Satpol PP (trantibum, penindakan Perda) & Damkar (kejadian kebakaran, non-kebakaran, sarana).
- **Verifikasi** & **validasi** Satu Data — standardisasi kode, definisi, dan periode (bulan/tahun).
- **Publikasi** dashboard Satu Data untuk pimpinan (piramida 12 laporan → 8 analisa → 6 evaluasi → 4 RTL).
